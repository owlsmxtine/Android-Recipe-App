...
public class SaladAdapter  extends RecyclerView.Adapter<SaladAdapter.MyViewHolder> {

    Context context;
    JSONArray jsonArray;
    public SaladAdapter(JSONArray jsonArray, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.salad_tab2,parent,false);
