...
public class VeAdapter  extends RecyclerView.Adapter<VeAdapter.MyViewHolder> {

    Context context;
    JSONArray jsonArray;
    public VeAdapter(JSONArray jsonArray, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ve_tab3,parent,false);
